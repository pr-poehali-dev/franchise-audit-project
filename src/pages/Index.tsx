...
export default function Index() {
  ...
  const problems = [
    ...
    {
      title: "Неясная реальная прибыль точек питания",
      description: "Франчайзер показывает вам идеальные цифры своей лучшей точки питания(кофейни, кафе, ресторана), а не средние показатели реально работающих франчайзи.",
      icon: "TrendingDown"
    },
    {
  ...
  const auditFeatures = [
    ...
    {
      title: "Анализ рынка и конкурентной среды",
      description: "Мы изучаем насыщенность рынка, потенциал спроса, ценообразование и активность конкурентов именно в вашем городе, чтобы оценить реальные возможности для успешного запуска и роста.",
      icon: "TrendingUp"
    },
    {
